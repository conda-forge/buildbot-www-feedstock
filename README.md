...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/buildbot-www-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7325&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/buildbot-www-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `buildbot-www` can be installed with:

```
conda install buildbot-www
```

It is possible to list all of the versions of `buildbot-www` available on your platform with:
